...
const subjects = [
  { name: 'Mathematics', icon: '🧮', class: 'bg-blue-500', description: 'Numbers, equations, and problem solving' },
  ...
  { name: 'Languages', icon: '🌐', class: 'bg-purple-500', description: 'Communication and literature' },
  ...
  { name: 'Technology', icon: '💻', class: 'bg-pink-500', description: 'Computing and digital skills' },
  { name: 'Arts', icon: '🎨', class: 'bg-orange-500', description: 'Creativity and visual expression' },
  { name: 'Music', icon: '🎵', class: 'bg-cyan-500', description: 'Rhythm, melody, and harmony' },
  { name: 'Sports', icon: '⚽', class: 'bg-lime-500', description: 'Physical education and athletics' },
  { name: 'Social Studies', icon: '👥', class: 'bg-rose-500', description: 'Society, culture, and civics' },
];
...
const SubjectBook = ({ selectSubject }) => {
  ...
  const nextSubject = currentPage < subjects.length - 1 ? subjects[currentPage + 1] : null;
  const prevSubject = currentPage > 0 ? subjects[currentPage - 1] : null;
      ...
      <div className="mt-[-10rem] sm:mt-[-6rem] flex flex-col gap-28 items-center justify-center min-h-screen p-2 sm:p-4 mb-12 overflow-hidden">
        ...
        <div className="relative perspective-1000">
          ...
          <div className="relative rounded-lg" style={{ width: '400px', height: '200px' }}>
              ...
              {isOpen && (
                <div className="w-full h-full bg-white rounded-l-lg">
                  {prevSubject ? (
                    ...
                    // Show welcome page when no previous subject exists
                    <div className="h-full flex flex-col">
                      <div className="bg-gradient-to-r from-amber-100 to-orange-100 p-2 border-b border-amber-200">
                      </div>
                      <div className="flex-1 p-3 flex flex-col items-center justify-center">
            ...
            <div className="absolute left-1/2 top-0 h-full w-4 bg-gradient-to-b from-amber-800 to-amber-900 transform -translate-x-1/2 z-30 rounded-sm flex items-center justify-center">
            ...
            {isFlipping && isOpen && (
              <>
                ...
                <div
                  className={`absolute top-0 h-full bg-white shadow-2xl z-40 transition-all duration-500 ease-in-out transform-gpu ${flipDirection === 'next'
                ...
                >
                  ...
                  <div className="absolute inset-0 backface-hidden rotate-y-180">
                      ...
                      <div className="h-full flex flex-col bg-white rounded-l-lg overflow-hidden">
                        ...
                        <div className="flex-1 p-3 flex flex-col items-center justify-center">
                          {nextSubject ? (
                            ...
                            <div className="text-amber-600 text-center">
                              <h4 className="text-sm font-bold">Restarting...</h4>
                            </div>
                          )}
                        </div>
                      </div>
                    ...
                    {flipDirection === 'prev' && currentSubject && (
                      <div className="h-full flex flex-col bg-white rounded-r-lg overflow-hidden">
                        <div className="bg-gradient-to-r from-orange-100 to-amber-100 p-2 border-b border-amber-200">
                        </div>
                        <div className="flex-1 p-3 flex flex-col items-center justify-center">
                          <div className={`w-12 h-12 flex items-center justify-center text-white rounded-full mb-3 shadow-lg ${currentSubject.class}`}>
