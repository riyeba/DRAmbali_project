...
const Header = () => {
  ...
  return (
    <>
      ...
      {/* MOBILE MENU - MOVED OUTSIDE PARENT DIV */}
      {isMobileMenuOpen && (
        <div
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-br from-blue-50 via-pink-50 to-purple-50 flex flex-col h-full w-full">
            {/* Mobile Header */}
            <div className="flex justify-between items-center p-4 bg-white/80 backdrop-blur-sm shadow-sm shrink-0">
