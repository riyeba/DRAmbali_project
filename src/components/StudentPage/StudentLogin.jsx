...
import { Mail, Lock, Eye, EyeOff, AlertCircle, CheckCircle, ChevronLeft } from 'lucide-react';
                    ...
                    <div className="p-6 sm:p-8 lg:p-12">
                        <div className="space-y-6">
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center">
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-2 focus:ring-blue-500/50 cursor-pointer"
                                    />
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <button
                                    type="button"
                                    className="flex items-center justify-center px-4 py-3 border-2 border-gray-200 rounded-xl font-semibold text-gray-700 hover:bg-gray-50 transition-all duration-200 hover:border-gray-300"
                                >
